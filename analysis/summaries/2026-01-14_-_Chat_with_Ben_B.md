...
**Date:** 2026-01-14
**Attendees:** Ben Brookes, Azmain Hossain, Richard Dosoo (partial)
**Duration context:** medium (~4000 words)
**Workstreams touched:** WS2 (CLARA/Adoption Tracker)

## Key Points
- Ben Brookes walks through a whiteboard/to-do list of feature priorities for CLARA in a Teams channel
...
- Ben senses Josh, Kathryn Palkovics, and Chanel gradually saying "Salesforce doesn't work, should we just give up?" -- considers this ideal for CLARA adoption
...
## Decisions Made
- **Data flows FROM CLARA to Salesforce, not reverse**: CLARA is the system of record for migration tracking -> Ben Brookes
  - **Type:** explicit
  - **Confidence:** HIGH
- **Team members mapping is top priority**: Must be done before user context, permissions, or personalised views -> Ben Brookes
  - **Type:** explicit
  - **Confidence:** HIGH
- **HD flags at use case level**: Track whether HD models are in production per use case -> Ben Brookes
  - **Type:** explicit
  - **Confidence:** HIGH
- **Table view replaces tab-based customer layout**: Azmain's redesign accepted -> Azmain/Ben
  - **Type:** implicit
  - **Confidence:** HIGH
- **Meet with Natalia/Kathryn Palkovics/Kevin before major schema changes**: Align data model with Gainsight integration plans -> Richard
  - **Type:** explicit
  - **Confidence:** MEDIUM
...
| Schedule alignment call with Natalia/Kathryn Palkovics/Kevin on data model | Richard | 2026-01-20 | Open | MEDIUM |
...
|-------|----------|-----------|------------|
| User context and permissions | technical | "this thing is not currently wired in to know who's on what teams" -- Ben Brookes | HIGH |
| Salesforce relationship | strategic | "Josh and Kathryn Palkovics and Chanel gradually say, okay, clearly Salesforce doesn't work" -- Ben Brookes | HIGH |
| HD adoption visibility gap | operational | "until we show the fact that nobody's actually using it in production... we won't do anything about the problem" -- Ben Brookes | HIGH |
| Travellers incident | interpersonal | "Mike Steele saying, Gary Nelson at Travellers is really pissed off. What's going on?" -- Ben Brookes | HIGH |
...
|--------|-------------------|----------------|--------------|
| Ben Brookes | Product owner, vision setter | Defining feature priorities, sharing the Travellers story to motivate, praising Opus | 45% |
...
|--------|-----------|-------|-------|-------|
| Ben Brookes | Urgent, visionary | Escalating urgency | Demo readiness | Travellers incident shows exactly why CLARA is needed NOW |
...
| Josh/Kathryn Palkovics/Chanel (ref) | Moving away from Salesforce | Gradual shift | Tool preference | Signals openness to CLARA replacing Salesforce for this use case |
...
| Ben Brookes | Will provide Valpers cultural commitments terminology for app | TBD | None | LOW |
...
- When will the alignment meeting with Natalia/Kathryn Palkovics/Kevin happen?
...
## Raw Quotes of Note
- "until we show the fact that nobody's actually using it in production because everybody's bloody blocked, we won't do anything about the problem" -- Ben Brookes, on HD visibility gap
- "Mike Steele saying, Gary Nelson at Travellers is really pissed off. What's going on?" -- Ben Brookes, on why CLARA matters
