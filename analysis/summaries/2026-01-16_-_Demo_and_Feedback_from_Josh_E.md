...
**Date:** 2026-01-16
**Attendees:** Josh Ellingson, Azmain Hossain, Ben Brookes
...
- Ben Brookes arrives mid-call; Josh shares that Andy Frappe's team is already misinterpreting data (requesting GMB numbers for migration when it should be zero)
...
- Ben Brookes proposes compromise: champions as feedback collators, not exclusive users -- show everyone but have designated people gather and triage feedback (Watson in London, Julia in Zurich, Dave Kenny in US)
...
- Ben Brookes: "we probably want it in here and then push to Gainsight on the back end"
...
- Ben Brookes reframes the messaging: "it's not data quality, it's data visibility" -- this is about multiple teams collaborating on the same data, not about fixing bad data
...
- **CSM champion model for feedback collection**: 2-3 champions per region collate feedback rather than all CSMs feeding back individually -> Josh (proposed), Ben (refined)
  - **Type:** explicit
  - **Confidence:** HIGH
- **Data visibility, not data quality, as positioning**: Messaging to CSMs and leadership should emphasise collaboration and visibility, not fixing bad data -> Ben Brookes (proposed), Josh (agreed)
  - **Type:** explicit
  - **Confidence:** HIGH
- **Feedback button replaces AI chat widget**: Screenshot-capture feedback mechanism front and centre on the UI -> Azmain
  - **Type:** explicit
  - **Confidence:** HIGH
- **Squad-based approach from day one**: Implementation leads and cross-functional team, not just CSMs -> Ben Brookes
  - **Type:** explicit
  - **Confidence:** HIGH
- **Two-phase demo rollout**: Portfolio/project people early next week, then broader CSM demo mid-week -> Azmain/Josh
  - **Type:** explicit
  - **Confidence:** HIGH
- **CLARA data pushes to Gainsight, not the reverse**: CLARA is the working system; Gainsight gets data pushed on the back end -> Ben Brookes
  - **Type:** explicit
  - **Confidence:** MEDIUM
...
| Coordinate with Josh on messaging for CSM rollout | Azmain/Ben Brookes | 2026-01-20 | Open | HIGH |

## Theme Segments
| Topic | Category | Key Quote | Confidence |
|-------|----------|-----------|------------|
| Data quality vs data visibility framing | strategic | "it's not data quality, it's data visibility" -- Ben Brookes | HIGH |
...
| Ben Brookes | Product owner, reframer | Arriving mid-call, reframing data quality to data visibility, proposing squad approach | 30% |
...
| Ben Brookes | Confident, politically savvy | Stable | Positioning | Reframed the entire conversation with "data visibility" |
...
| Kathryn Palkovics (referenced) | Digital engagement champion | Stable | Service model change | Working on digital engagement that will change how CSMs operate |
...
| Ben Brookes | Will work on squad-based rollout messaging | Before CSM demo | None | MEDIUM |
...
- "it's not data quality, it's data visibility" -- Ben Brookes, reframing the entire messaging
- "any pushback I have is about data quality, not about function. I think the function is great" -- Josh, closing assessment
- "I got a request this morning from one of Andy Frappe's minions saying how much I need the GMB number right now from all the migrations" -- Ben Brookes, on existing data misinterpretation
