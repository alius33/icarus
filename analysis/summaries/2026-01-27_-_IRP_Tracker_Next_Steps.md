...
**Date:** 2026-01-27
**Attendees:** Richard Dosoo, Ben Brookes, Azmain Hossain, BenVH (Speaker 2), Martin Davies (Speaker 1)
...
- Ben Brookes firmly chose CLARA as the priority -- "fast and safe" -- agreeing that Martin and Azmain should work in parallel on tracker features rather than diverting Martin to platform work
...
- Azmain proposed work split: he handles data chasing (Kathryn Palkovics, Natalia, Stacey) and audit trail; Martin handles RBAC with BenVH on backend
...
- Ben Brookes wants Watson as the bellwether user -- if Watson adopts, everyone will follow; Watson was complaining about double entry on adoption charters
...
- Ben Brookes acknowledged partner requests but explicitly deprioritised
...
- Ben Brookes insisted on human review/approval for any transcript-to-database writes -- no automatic updates

## Decisions Made
- Priority order: CLARA features first, platform infrastructure second
  - **Type:** explicit (Ben Brookes)
  - **Confidence:** HIGH
...
|--------|-------|----------|--------|------------|
| Chase Kathryn Palkovics, Natalia, Stacey for latest golden source data | Azmain | Wed Jan 28 | Open | HIGH |
...
| Post in Teams channel about Wednesday data cutoff | Ben Brookes | Mon Jan 27 | Open | HIGH |
...
| Introduce BenVH to Victor for MAP infrastructure decision | Richard + Ben Brookes | This week | Open | LOW |
...
|-------|----------|-----------|------------|
| Feature prioritisation and resource allocation | Planning/Strategy | "Priority number one has to be adoption tracker for a while longer" -- Ben Brookes | HIGH |
| Data quality and golden source timeline | Data/Operations | "End of tomorrow data is the data... every edge case can be mocked up by a CSM" -- Ben Brookes | HIGH |
...
| Watson as bellwether user | Adoption/Strategy | "If we can get him to come along, everyone will follow" -- Ben Brookes (paraphrased) | HIGH |

## Power Dynamics
| Person | Role This Meeting | Influence Acts | Engagement % |
|--------|-------------------|----------------|--------------|
| Ben Brookes | Strategic decision-maker, priority setter | Chose CLARA over platform, set deadlines, overrode tangents | 30% |
...
|--------|-----------|-------|-------|-------|
| Ben Brookes | Focused, decisive | Stable -- doubling down on tracker | Priorities | "Fast and safe, right? Priority number one has to be adoption tracker" |
...
| Azmain | Energised, multitasking | Positive -- clear work plan, but pulled toward partner workshop | Work split | "If me and Martin can split the work... I'm going to start chasing Kathryn Palkovics, Natalia, Stacey" |
...
|--------|------------|------------------|-----------|------------|
| Ben Brookes | Post Wednesday data cutoff announcement in Teams | Today/tomorrow | None | HIGH |
| Azmain | Chase data owners and complete data preparation | By Wednesday | Kathryn Palkovics/Natalia cooperation | HIGH |
...
| Ben Brookes | Ping Josh, George, Natalia, Stacey, Kathryn Palkovics about Monday readiness | This week | None | HIGH |
...
| R-W4-25 | NEW | Ben Brookes insists on human approval for all transcript-to-database writes -- limits AI automation potential | LOW | Philosophical difference | Ben vs Azmain | MEDIUM |
...
## Raw Quotes of Note
- "Fast and safe, right? So I think priority number one has to be adoption tracker for a while longer" -- Ben Brookes, setting the strategic direction
- "We're building technical debt as we go, but we'll fix it" -- Richard, on the pragmatic approach
- "If he says one more time, please don't use this tracker. I'm going to fly over there and punch it" -- Ben Brookes, on Josh's resistance to CLARA
- "It's just not a priority" -- Ben Brookes, on partner functionality requests
- "We were always gonna have to do a fresh" -- Azmain, on the need for a clean data load

## Narrative Notes
This was a disciplined sprint planning session that translated yesterday's strategic decisions into concrete work assignments. Ben Brookes's "fast and safe" principle is the governing philosophy: move quickly on features that remove adoption barriers (RBAC, audit trail, data quality) while deferring everything that does not directly enable the Monday launch. His explicit deprioritisation of partner functionality -- despite Alexandra's eagerness -- shows clear strategic focus.
...
The AWS Bedrock discovery is genuinely exciting for the team -- if they can access Opus 4.5 through corporate infrastructure, it eliminates a significant cost and access bottleneck for AI features. This could accelerate the transcript analysis, natural language querying, and AI-assisted data entry features that Ben Brookes envisions as CLARA's differentiators.
