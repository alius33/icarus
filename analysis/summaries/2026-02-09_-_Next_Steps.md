...
## Key Points
- Richard sets the data strategy for the week: Kathryn Palkovics must take complicated accounts (complex reinsurer, complex primary, complex broker, complex global entity) and sense-check the data in CLARA against what she expects. Goal is to surface 80-90% of data mapping issues in one pass rather than picking them off incrementally.
...
- Azmain reports ongoing frustration with Kathryn Palkovics and Josh being surprised by data discrepancies each call despite having provided the original data. Kathryn Palkovics is described as reluctant to explore the app independently.
...
- Azmain proposes emailing Kathryn Palkovics, Josh, Natalia, Richard, and Ben with a clear ask: go through complex accounts, document gaps in a Word doc by end of Tuesday US time, then a call Wednesday to start fixing.
...
|----------|------|---------|------------|
| Data strategy this week: Kathryn Palkovics sense-checks complex accounts, no other feature work until data is stable | Priority | Richard | High |
...
|--------|-------|----------|--------|------------|
| Email Kathryn Palkovics/Josh/Natalia/Ben with data sense-check ask | Azmain | 2026-02-09 | Open | High |
| Kathryn Palkovics to sense-check complex accounts against CLARA data | Kathryn Palkovics | End of Tue 2026-02-11 | Open | Medium — depends on Kathryn Palkovics' engagement |
...
|------------|-------|--------------|
| 0:00-4:00 | Kathryn Palkovics/Josh engagement problem and data strategy | Richard, Azmain |
...
## Power Dynamics
- **Richard is the strategist and mentor.** He reframes Azmain's frustration with Kathryn Palkovics into a tactical engagement problem and proposes a solution. The tone is patient and coaching — not directive.
- **Azmain vents but accepts guidance.** His frustration with Kathryn Palkovics is palpable but he channels it productively once Richard provides the reframe.
...
## Stakeholder Signals
- **Richard:** Tactically reframing the engagement approach — moving from "show them the output" to "involve them in the process" to address Kathryn Palkovics and Josh's resistance. Shows strategic patience.
- **Azmain:** Visibly frustrated with the pace of stakeholder engagement, especially Kathryn Palkovics' reluctance to explore the app and repeated surprise about data she originally provided. Wants to move fast but is blocked by social friction.
...
- **Kathryn Palkovics (discussed, not present):** Described as scared to explore the app. Richard attributes this to the broader engagement dynamic, not a personal failing. The golden source spreadsheet she maintains is too messy to import programmatically.

## Commitments Made
| Who | Commitment | To Whom | Strength |
|-----|-----------|---------|----------|
| Azmain | Send email to Kathryn Palkovics/Josh/Natalia/Ben with data ask | Richard | Firm |
| Richard | Jump on a call with Kathryn Palkovics if needed to help navigate | Azmain | Conditional |
...
| Follow-through potential | 3 | Depends heavily on Kathryn Palkovics' willingness to engage |

## Risk Signals
- **Kathryn Palkovics engagement risk:** If Kathryn Palkovics does not complete the sense-check by Tuesday, the Wednesday fix session cannot happen, and the weekly cycle slips again. Richard's reframe is good strategy but depends on execution.
