...
**Date:** 2026-02-19
**Attendees:** Richard Dosoo, Azmain Hossain, Ben Brooks, Bala (Speaker 1 / new from banking/edfx), Cihan (Jihan / Speaker 2), Lonny (Speaker 5), Nikhil (Speaker 3)
**Duration context:** Long (~40 minutes)
**Workstreams touched:** WS5 IRP Navigator / L1 Automation, WS6 Build in Five (tangentially)

## Key Points
- This is the first cross-functional meeting between the CS Gen AI programme team (Richard, Azmain, Ben Brooks) and the product team (Cihan/Jihan, Lonny, Bala) on MCP server development for IRP.
...
- Ben Brooks is "super bullish" -- suggests the first GA release could target partners only (internal + partners) to control rollout while accelerating the prime onboarding process.
...
| MCP server will be free -- positioned as another consumption interface, not a paid product | Pricing/packaging | High | Cihan / Ben Brooks |
...
| First GA release could be partners-only to control rollout | Go-to-market | Medium | Ben Brooks (suggestion, not finalised) |
...
| 3:30-6:15 | Context setting: why CS team wants to build on IRP APIs for demos and pipeline | Richard, Ben Brooks |
...
| 20:00-26:30 | Strategic product discussion: IRP Navigator integration, Cat Moss, product roadmap conflicts | Cihan, Ben Brooks, Richard |
...
- **Ben Brooks operates as the commercial strategist** -- pushes for GA, frames it commercially (consumption driver), suggests partners-only rollout as risk management. His contributions are concise and high-impact.
...
- **Ben Brooks:** Commercially bullish. Sees MCP as consumption driver. Thinking about the fundamental question of what Moody's business model looks like in an agentic world -- people asking questions "because it's easy, rather than because they have to."
...
- "I don't think people gonna wait hours for models to run when you're talking to an agent to try and get an answer." -- Ben Brooks, on the fundamental shift in how the business model works in an agentic world
