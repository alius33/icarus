# Build in 5 Discussion
**Date:** 2026-03-04
**Attendees:** Richard Dosoo, Azmain Hossain, Martin Davies
**Duration context:** Short-Medium (~16 minutes)
**Workstreams touched:** WS6 Build in Five, App Factory / Infrastructure
...
- Stacy is asking about timesheet entries and financial tracking for these projects. Richard will create projects in FinancialForce.
- Dependencies between Build in Five and App Factory need to be clarified -- whether Martin needs App Factory foundations before completing his work, or can proceed independently.
...
## Theme Segments
1. **App Factory input funnel concept** (0:00-3:00) -- Richard describes Azmain's vision for an idea-to-deployment pipeline
2. **Exceedance timeline and scope** (3:00-8:00) -- May target, content by April, Ben's innovation panel
3. **Demo approach: reverse-engineer Apollo** (8:00-12:00) -- Martin's dashboard as the first demo scenario
...
|-----------|-------------|-------|
| Clarity of outcomes | 7 | Clear first demo, pending Ben's input for 2nd/3rd |
| Decision quality | 7 | Pragmatic approach (reverse-engineer existing work) |
| Participation balance | 5 | Azmain mostly absent; Martin/Richard productive |
| Action item specificity | 7 | Good specificity with "this week" timelines |
| Strategic alignment | 7 | Aligns with Exceedance but Ben's absence creates uncertainty |
...
- Will the Exceedance timelines actually work?
- What are the second and third demo scenarios?
- Does Build in Five have a hard dependency on App Factory foundations?
- When will the two analyst grads arrive?

## Raw Quotes of Note
- "I didn't commit that we could. I said to him, I need to talk to you about the timelines first." -- Richard, on managing Exceedance expectations
