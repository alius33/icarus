...
**Date:** 2026-03-10
**Attendees:** Richard Dosoo, Azmain Hossain, Ben Brooks (late), Jack Cheyne, Christian Curran
...
- Ben Brooks (arriving late) presented the **App Factory** concept — the infrastructure for hosting internally-developed apps on AWS
...
| Follow up on App Factory hosting options for Life team tools | Ben Brooks | TBD | Open |
