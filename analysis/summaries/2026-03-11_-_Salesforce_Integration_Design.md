...
**Date:** 2026-03-11
**Attendees:** Azmain Hossain, BenVH, Richard Dosoo, Catherine
...
- Catherine joined and asked the critical framing question: what exactly are we building? She wanted to understand the specific use cases, not just the objects
...
- Catherine clarified the CLARA/Gainsight relationship: CLARA is for IRP adoption/migration (interim), ongoing CSM activity goes to Gainsight. The App Factory approach makes sense because it pulls data from multiple sources for unique analytics
- Gainsight goes live March 30 (hard launch, confirmed by Catherine). Azmain concerned about immediate "does Clara sync with Gainsight?" questions
- Catherine reassured: no IRP adoption info expected in Gainsight at launch — it's for day-to-day CSM activities only
- Catherine raised NPS data as a potential addition — Voice of Customer surveys currently feed into Gainsight, could be brought directly into App Factory
- Rhett has been working on ticket and User Voice analysis independently — Catherine flagged potential duplication
- Next steps: Richard to tidy the design document, Azmain to align MCP approach with latest thinking, Catherine to share with wider team for tomorrow's meeting (Gainsight integration meeting)

## Decisions Made
- Salesforce integration one-way only (read, no write back) → All agreed
- Key data objects: Cases and Case Feed only (phase 1) → Richard/Catherine
...
- New account creation flow: auto-trigger from Gainsight when new client signed, with approval step in CLARA → Catherine/Azmain
- NPS data integration to be explored as future enhancement → Catherine suggestion
...
| Share updated design with wider team for tomorrow's Gainsight meeting | Catherine/Richard | 11 Mar | Open |
...
| Explore NPS/Voice of Customer data integration into App Factory | Richard/Catherine | TBD | Open |
| Investigate Gainsight API for new account auto-sync trigger | Azmain | After March 30 launch | Open |

## Stakeholder Signals
- **Catherine** — Most engaged she's been with the programme. Her question about philosophy ("is the App Factory a platform for analytics from multiple sources?") showed she grasps the strategic vision. Called the approach "breaking down siloed walls" — now a strong ally, not the potential detractor flagged earlier
...
## Raw Quotes of Note
- "It essentially breaks down the siloed walls, and that's going to be huge." — Catherine, on the App Factory approach to multi-source analytics
