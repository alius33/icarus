...
**Date:** 2026-03-12
**Attendees:** Azmain Hossain, Natalia Plant, Stacy Dixtra, Kathryn Palkovics
...
- Ben Brookes governance concern: he bypasses the process by building things himself. Agreed solution: Ben can use the sandbox freely but must not push to user-facing production
...
- Kathryn Palkovics raised feature governance concern about changes being made without wider review or consideration of downstream effects
...
- Tuesday prioritisation review meetings starting next week (Azmain, Natalia, Stacy, Kathryn Palkovics)
- Fortnightly release cadence going forward (at least until grads join and things stabilise)
- Ben Brookes can use sandbox but not push to production outside the release cycle
...
- Kathryn Palkovics/Stacy to have visibility into the feedback request list for governance
- Azmain to fix back-button scroll position issue

## Action Items
| Action | Owner | Deadline | Status |
|--------|-------|----------|--------|
| Give Kathryn Palkovics/Stacy/Natalia access to the feedback request list | Azmain | Before Tuesday | Open |
...
- Kathryn Palkovics: raising valid governance points (unintended downstream effects from changes) but tone is monitoring/controlling. Referenced a removed field that broke dashboard calculations.
...
- What happens when Ben Brookes builds something in sandbox that the team doesn't want in production?
