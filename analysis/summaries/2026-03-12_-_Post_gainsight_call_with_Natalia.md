# Post Gainsight Call with Natalia
**Date:** 2026-03-12
**Attendees:** Azmain Hossain, Natalia Orzechowska
**Duration context:** Short (~7 minutes)
**Primary project:** CLARA (IRP Adoption Tracker)
**Secondary projects:** Program Management

## Key Points
- Quick reassurance call initiated by Natalia after the Gainsight integration meeting
...
## Decisions Made
- No Clara/Gainsight POC before end of March — earliest May timeframe
- Integration work will be prioritised through the new Tuesday governance review process
- Wait for grads (April 7) before committing resource to Gainsight integration
...
- Will the Gainsight team's go-live on March 30 generate immediate "does Clara sync?" questions from users?
- How will Bernard's negative Gainsight experience affect the team's willingness to invest in integration?

## Raw Quotes of Note
- "The thing that the central team is actually talking to us about some sort of communication integration — this is already huge, because before they were not really willing to do anything with us" — Natalia Orzechowska, on the significance of the Gainsight team engaging
