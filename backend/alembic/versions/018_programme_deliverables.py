...
def upgrade():
    ...
    # Pillar 1: IRP Portfolio Governance -> CLARA (project_id linked by import_data.py)
    # NOTE: project_id set to None here because projects don't exist during migration
    # on a fresh database. import_data.py links deliverables to projects after import.
    deliverables = [
        dict(id=1, pillar=1, pillar_name="IRP Portfolio Governance", title="Real-time visibility into IRP adoption, milestones, and blockers", description="CLARA dashboard providing live view of IRP adoption status across clients", position=0, project_id=None, rag_status="GREEN", progress_percent=33, notes="CLARA is live and being used by CSMs. Dashboard shows adoption data."),
        dict(id=2, pillar=1, pillar_name="IRP Portfolio Governance", title="Automated adoption charters generation", description="Auto-generate adoption charter documents from IRP data", position=1, project_id=None, rag_status="AMBER", progress_percent=0, notes="Charter template design not yet started."),
        dict(id=3, pillar=1, pillar_name="IRP Portfolio Governance", title="60-90% reduction in manual reporting effort", description="Reduce manual reporting through CLARA automation", position=2, project_id=None, rag_status="GREEN", progress_percent=33, notes="Initial automation reducing some manual work. Further reduction expected as CLARA matures."),
        dict(id=4, pillar=1, pillar_name="IRP Portfolio Governance", title="Clear tracking of onboarding progress, blockers and outcomes", description="End-to-end onboarding tracking in CLARA", position=3, project_id=None, rag_status="GREEN", progress_percent=33, notes="Blocker tracking operational. Onboarding flow being refined."),
        dict(id=5, pillar=1, pillar_name="IRP Portfolio Governance", title="Future Phases: Casualty & Cyber products", description="Extend CLARA to cover Casualty and Cyber product lines", position=4, project_id=None, rag_status="GREEN", progress_percent=0, notes="Not yet started — scheduled for later phases."),
        # Pillar 2: Platform-Embedded Customer Intelligence -> CS Agent, Navigator
        dict(id=6, pillar=2, pillar_name="Platform-Embedded Customer Intelligence", title="AI-assisted case preparation and executive meeting support", description="AI tools to prepare CSMs for client meetings with relevant data and talking points", position=0, project_id=None, rag_status="AMBER", progress_percent=0, notes="Concept defined but not yet built."),
        dict(id=7, pillar=2, pillar_name="Platform-Embedded Customer Intelligence", title="Intelligence layer connecting Salesforce and IRP usage data", description="Bridge between Salesforce CRM data and IRP platform usage metrics", position=1, project_id=None, rag_status="AMBER", progress_percent=0, notes="Data mapping in early stages. Salesforce integration requires coordination."),
        dict(id=8, pillar=2, pillar_name="Platform-Embedded Customer Intelligence", title="Navigator API testing embedded into CS workflows", description="IRP Navigator API testing integrated into daily CS operations", position=2, project_id=None, rag_status="GREEN", progress_percent=33, notes="Navigator API analysis underway. L1 automation concepts developing."),
        dict(id=9, pillar=2, pillar_name="Platform-Embedded Customer Intelligence", title="Foundation for automated L1 triage via Salesforce skill", description="Automated first-level support triage using Salesforce skill integration", position=3, project_id=None, rag_status="AMBER", progress_percent=0, notes="Dependent on Navigator API and Salesforce integration."),
        # Pillar 3: Internal Productivity & Revenue Acceleration -> Build in Five, App Factory
        dict(id=10, pillar=3, pillar_name="Internal Productivity & Revenue Acceleration", title="Rapid client POC development for Property & Casualty", description="Build in Five framework for rapid POC delivery", position=0, project_id=None, rag_status="GREEN", progress_percent=33, notes="Martin actively developing. Build in Five framework operational."),
        dict(id=11, pillar=3, pillar_name="Internal Productivity & Revenue Acceleration", title="Live API demonstrations in pre-sales", description="Real-time API demos for pre-sales meetings", position=1, project_id=None, rag_status="AMBER", progress_percent=0, notes="Demo environment setup in progress."),
        dict(id=12, pillar=3, pillar_name="Internal Productivity & Revenue Acceleration", title="Improved delivery velocity and pipeline conversion", description="Faster delivery cycles and better pipeline conversion rates", position=2, project_id=None, rag_status="GREEN", progress_percent=33, notes="App Factory platform operational. Deployment automation working."),
