...
- **Audience** — who is this for? (e.g. "Diya", "the steering group", "Ben Brookes", "the team")
...
4. `analysis/trackers/risk_register.md` — if the audience cares about risks (Diya: yes, surface level; Ben Brookes: yes, strategic; team: yes, tactical)
...
- **Ben Brookes:** Strategic thinker. Cares about product direction, platform vision, competitive positioning. Tolerates detail if it's relevant. Can handle nuance.
