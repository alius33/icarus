...
export default function ProjectTabBar({ counts }: Props) {
  ...
  return (
    <div className="border-b border-forest-200 dark:border-forest-700 bg-white dark:bg-forest-800 dark:bg-forest-900 overflow-x-auto scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0">
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "border-transparent text-forest-400 hover:border-forest-200 hover:text-forest-600",
              )}
            >
              {tab.label}
